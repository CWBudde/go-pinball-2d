...
func generatedAssets() ([]generatedFile, error) {
	images := []struct {
		...
		{"images/bumper-material.png", bumperMaterialImage},
		{"images/bumper-hit.png", bumperHitImage},
		{"images/bumper-patch.png", bumperPatchImage},
		{"images/bumper-shadow.png", bumperShadowImage},
		{"images/bumper-emission.png", bumperEmissionImage},
		...
		{"images/plunger-head.png", plungerHeadImage},
		{"images/plunger-coil.png", plungerCoilImage},
		{"images/plunger-rod.png", plungerRodImage},
